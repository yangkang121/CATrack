...
def run(settings):
    settings.description = 'Training script for TBSI RGB-T Tracker' # 'Training script for STARK-S, STARK-ST stage1, and STARK-ST stage2'
    ...
    if settings.script_name == "odtrack":
        ...
        loss_weight = {'giou': cfg.TRAIN.GIOU_WEIGHT, 'l1': cfg.TRAIN.L1_WEIGHT, 'focal': 1.0, 'cls': 1.0, 'var':cfg.TRAIN.VAR_WEIGHT,}
