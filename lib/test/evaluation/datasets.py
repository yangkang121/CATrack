...
dataset_dict = dict(
    ...
    webuavrgbt=DatasetInfo(module=pt % "webuavrgbt", class_name="WebUAVRGBTDataset", kwargs=dict(split='')),
    hial_test=DatasetInfo(module=pt % "hial", class_name="HiALDataset", kwargs=dict(split='testingset'))
)
